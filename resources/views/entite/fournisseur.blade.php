      ...
      <div class="row">
            ...
            <tbody>
              @foreach ($fournisseurs as $fourisseur)
                <tr style="cursor: pointer">
                  <th scope="row">{{$fourisseur->id}}</th>
                  <td>{{$fourisseur->nom}}</td>
                  @if ($fourisseur->adresse)
                    <td>{{$fourisseur->nom}}</td>
                  @endif
                  <td>{{$fourisseur->telephone}}</td>
                  {{-- <td>{{$client->commande}}</td>
                  <td>{{$client->quantite}}</td> --}}
                  <td>{{$fourisseur->created_at}}</td>
                </tr>
              @endforeach
        ...
        <div id="modalTwo" class="modal" >
              ...
              <div class="contact-form">
                ...
                <form method="POST" action="{{route('fournisseur.store')}}" style="background: white;" >
                  {{ csrf_field() }}
