...
class DepenseController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       return  redirect()->route('depenses.index')->with('success','Depenses Crée avec succes');
    }
    ...
    public function update(Request $request, Depense $depense)
    {
        ...
        return  redirect()->route('depenses.index')->with('success','Depenses Modifiée avec succes');
